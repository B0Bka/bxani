					...
					<div class="basket-items-list-container" id="basket-items-list-container">
						...
						<div class="basket-items-list" id="basket-item-list">
							...
							<table class="basket-items-list-table" id="basket-item-table">
                                    <tr class="basket-items-list-head">
                                        <td><?=i18n('COL_NAME', 'order')?></td>
                                        <td><?=i18n('COLOR')?></td>
                                        <td><?=i18n('SIZE')?></td>
                                        <td><?=i18n('SHORT_COUNT')?></td>
                                        <td><?=i18n('ORDER_PRICE', 'order')?></td>
                                        <td><?=i18n('ORDER_SUMM', 'order')?></td>
                                    </tr>
                            </table>
						</div>
					</div>
                    <div class="clear-basket">
                        <a href="javascript:void(0);" onclick="BX.Sale.BasketComponent.clearBasket()"><?=i18n('CLEAR_BASKET', 'order')?></a>
                    </div>
				</div>
                <div class="col-12 basket-total-block" data-entity="basket-total-block" id="basket-total"></div>
			</div>
		</div>
	</div>
	<?
...
{?>
    ...
    <a href="/catalog/" class="empty-btn basket-btn-checkout"><?=i18n('TO_CATALOG_BASKET', 'order')?></a>
<?}?>