...
class BasketItem extends AbstractModel implements DiscountPricebleInterface
{
    ...
    public function getProduct()
    {
        if(is_null($this->product))
        {
            ...
            if(!empty($offer)) $productId = $offer->getProductId();
    ...
    {
        return $this->getProduct()->getPrice($format);
    }
    
    public function getMaxPrice($format = false)
    {
        return $this->getProduct()->getBasePrice($format);
    }
    ...
    {
        return $this->getOffer()->getArticle();
    }
}
