...
use Aniart\Main\Traits\OfferPropCodeTrait;
...
class Offer extends IblockElementModel implements DiscountPricebleInterface
{
    ...
    {
        return $this->getPropertyValue("CML2_BAR_CODE");
    }
    /*Для google adwords*/
    public function getMpn()
    {
        return !empty($this->getPropertyValue("CML2_BAR_CODE")) ? $this->getPropertyValue("CML2_BAR_CODE") : $this->getArticle();
    }

    public function getSize()
    {
        return $this->getPropertyValueName($this->getPropCode('size'));
    }
    
    public function getSizeData()
    {
        return $this->getPropertyValueData($this->getPropCode('size'));
    }
    ...
    public function getAstrafitId()
    {
        return $this->getPropertyValue('ASTRAFIT_ID');
    }
