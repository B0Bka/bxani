...
class SeoParamsCollector extends ParameterDictionary
{
    ...
    {
        $this->setPageTitle($entity->getSeoPageTitle());
        $this->setMetaTitle($entity->getSeoMetaTitle());
        $this->setKeywords($entity->getSeoKeywords());
        $this->setDescription($entity->getSeoDescription());

	    return $this;
    }

    public function fetchSeoParamsByArray(array $seoParams)
    {
        $this->setPageTitle($seoParams['page_title']);
        $this->setMetaTitle($seoParams['meta_title']);
        $this->setKeywords($seoParams['keywords']);
        $this->setDescription($seoParams['description']);
